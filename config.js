...
module.exports = {
    ...
    USERNAME: process.env.𝗔𝗬𝗔𝗭 || '',
    SESSION: process.env.SESSION || '',
    RG: process.env.RG || '923032112917-1632403322@g.us',
    ...
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? '𝗔𝗬𝗔𝗭¹¹ꫂ;Raganork MD bot;https://www.linkpicture.com/q/rgnk.jpg' : process.env.AUDIO_DATA,
    ...
    SUDO: process.env.SUDO || '923112345043,0',
